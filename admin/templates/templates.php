...
<?php function navbar($active){?>
        ...
        <!-- Logo -->
        <a href="dashboard.php" class="logo"><i class="glyphicon glyphicon-home"></i> Phone Book</a>
...
<?php
        ...
        $member=$_SESSION['ID'];
        $query=mysqli_query($conn,"select * from user where ID='$member'")or die(mysqli_error());
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <img src="../image/<?php echo $row['image']; ?>" class="user-image" alt="User Image"/>
                  <span class="hidden-xs"><?php echo $row['name']; ?></span>
                </a>
                <ul class="dropdown-menu">
                  <!-- User image -->
                  <li class="user-header">
                    <img src="../image/<?php echo $row['image']; ?>" class="img-circle" alt="User Image" />
                    <p>
                      <?php echo $row['name']; ?>
                    </p>
                  </li>
                  ...
                  <li class="user-body">
                    <div class="col-xs-4 text-center">
                      <a href="../pages/account.php">Change Username</a>
                    </div>
                    <div class="col-xs-4 text-center pull-right">
                      <a href="../pages/account.php">Change Password</a>
                    </div>
                  </li>
                </ul>
              </li>
...
<?php
      ...
      ?>  
              <img src="../image/<?php echo $rows['image']; ?>" class="img-circle" alt="User Image" />
            </div>
          ...
          <ul class="sidebar-menu">
            ...
            ?>
              <a href="phonebook.php">
                <i class="glyphicon glyphicon-home"></i> <span>Phone Book</span>
              </a>
            </li>
            ...
            ?>
              <a href="account.php">
                <i class="glyphicon glyphicon-list-alt"></i> <span>Account</span>
              </a>
            </li>
